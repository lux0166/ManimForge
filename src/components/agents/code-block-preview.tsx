  ...
  return (
    <div className="relative h-[340px] w-full max-w-xl">
      ...
      <button
        ...
        className="absolute bottom-0 left-0 inline-flex items-center gap-1.5 rounded-full px-2 py-1 text-xs font-medium text-ink-3 outline-none transition-colors hover:bg-hover-2 hover:text-ink focus-visible:ring-2 focus-visible:ring-primary"
      >
